package com.test.androidtwitterlogin;
    ...
    extends Activity
{
    ...
    static String                    TWITTER_CONSUMER_KEY       =
                                                                    "Y1tDLm0rA6pMTguj8RHdg";
    static String                    TWITTER_CONSUMER_SECRET    =
                                                                    "WwN53PHh260A3YJlBpLVQQzfoon1IE4f2WUxneVCsBs";
    ...
    static final String              URL_TWITTER_OAUTH_VERIFIER =
                                                                    "oauth_verifier";
